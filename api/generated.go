...
// CommandJobCancelJobTypeCommandCancelJobTypeCommandCancelPayload includes the requested fields of the GraphQL type JobTypeCommandCancelPayload.
// The GraphQL type's documentation follows.
//
// Autogenerated return type of JobTypeCommandCancel
type CommandJobCancelJobTypeCommandCancelJobTypeCommandCancelPayload struct {
	// A unique identifier for the client performing the mutation.
	ClientMutationId string `json:"clientMutationId"`
}

// GetClientMutationId returns CommandJobCancelJobTypeCommandCancelJobTypeCommandCancelPayload.ClientMutationId, and is useful for accessing the field via an interface.
func (v *CommandJobCancelJobTypeCommandCancelJobTypeCommandCancelPayload) GetClientMutationId() string {
	return v.ClientMutationId
}

// CommandJobCancelResponse is returned by CommandJobCancel on success.
type CommandJobCancelResponse struct {
	// Cancel a job.
	JobTypeCommandCancel CommandJobCancelJobTypeCommandCancelJobTypeCommandCancelPayload `json:"jobTypeCommandCancel"`
}

// GetJobTypeCommandCancel returns CommandJobCancelResponse.JobTypeCommandCancel, and is useful for accessing the field via an interface.
func (v *CommandJobCancelResponse) GetJobTypeCommandCancel() CommandJobCancelJobTypeCommandCancelJobTypeCommandCancelPayload {
...
// __CommandJobCancelInput is used internally by genqlient
type __CommandJobCancelInput struct {
	Input JobTypeCommandCancelInput `json:"input"`
}

// GetInput returns __CommandJobCancelInput.Input, and is useful for accessing the field via an interface.
func (v *__CommandJobCancelInput) GetInput() JobTypeCommandCancelInput { return v.Input }
...
func CommandJobCancel(
	ctx context.Context,
	client graphql.Client,
	input JobTypeCommandCancelInput,
) (*CommandJobCancelResponse, error) {
	req := &graphql.Request{
		OpName: "CommandJobCancel",
		Query: `
mutation CommandJobCancel ($input: JobTypeCommandCancelInput!) {
	jobTypeCommandCancel(input: $input) {
		clientMutationId
	}
}
`,
		Variables: &__CommandJobCancelInput{
			Input: input,
		},
	}
	var err error

	var data CommandJobCancelResponse
	resp := &graphql.Response{Data: &data}
