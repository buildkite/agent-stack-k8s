...
func Run(
	...
	sched := scheduler.New(logger.Named("scheduler"), k8sClient, agentClient, scheduler.Config{
		...
		DefaultImageCheckContainerCpuLimit:    cfg.DefaultImageCheckContainerCpuLimit,
		DefaultImageCheckContainerMemoryLimit: cfg.DefaultImageCheckContainerMemoryLimit,
