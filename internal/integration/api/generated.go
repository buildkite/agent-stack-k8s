...
// ClusterQueueDeleteClusterQueueDeleteClusterQueueDeletePayload includes the requested fields of the GraphQL type ClusterQueueDeletePayload.
// The GraphQL type's documentation follows.
//
// Autogenerated return type of ClusterQueueDelete.
type ClusterQueueDeleteClusterQueueDeleteClusterQueueDeletePayload struct {
	DeletedClusterQueueId string `json:"deletedClusterQueueId"`
}

// GetDeletedClusterQueueId returns ClusterQueueDeleteClusterQueueDeleteClusterQueueDeletePayload.DeletedClusterQueueId, and is useful for accessing the field via an interface.
func (v *ClusterQueueDeleteClusterQueueDeleteClusterQueueDeletePayload) GetDeletedClusterQueueId() string {
...
// ClusterQueueDeleteResponse is returned by ClusterQueueDelete on success.
type ClusterQueueDeleteResponse struct {
	// Delete a cluster queue.
	ClusterQueueDelete ClusterQueueDeleteClusterQueueDeleteClusterQueueDeletePayload `json:"clusterQueueDelete"`
}

// GetClusterQueueDelete returns ClusterQueueDeleteResponse.ClusterQueueDelete, and is useful for accessing the field via an interface.
func (v *ClusterQueueDeleteResponse) GetClusterQueueDelete() ClusterQueueDeleteClusterQueueDeleteClusterQueueDeletePayload {
...
// GetOrganizationQueuesOrganization includes the requested fields of the GraphQL type Organization.
// The GraphQL type's documentation follows.
//
// An organization
type GetOrganizationQueuesOrganization struct {
	Id string `json:"id"`
	// Returns clusters for an Organization
	Clusters GetOrganizationQueuesOrganizationClustersClusterConnection `json:"clusters"`
}

// GetId returns GetOrganizationQueuesOrganization.Id, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganization) GetId() string { return v.Id }

// GetClusters returns GetOrganizationQueuesOrganization.Clusters, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganization) GetClusters() GetOrganizationQueuesOrganizationClustersClusterConnection {
	return v.Clusters
}

// GetOrganizationQueuesOrganizationClustersClusterConnection includes the requested fields of the GraphQL type ClusterConnection.
type GetOrganizationQueuesOrganizationClustersClusterConnection struct {
	Edges    []GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdge `json:"edges"`
	PageInfo GetOrganizationQueuesOrganizationClustersClusterConnectionPageInfo           `json:"pageInfo"`
}

// GetEdges returns GetOrganizationQueuesOrganizationClustersClusterConnection.Edges, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnection) GetEdges() []GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdge {
	return v.Edges
}

// GetPageInfo returns GetOrganizationQueuesOrganizationClustersClusterConnection.PageInfo, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnection) GetPageInfo() GetOrganizationQueuesOrganizationClustersClusterConnectionPageInfo {
	return v.PageInfo
}

// GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdge includes the requested fields of the GraphQL type ClusterEdge.
type GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdge struct {
	Node GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeCluster `json:"node"`
}

// GetNode returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdge.Node, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdge) GetNode() GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeCluster {
	return v.Node
}

// GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeCluster includes the requested fields of the GraphQL type Cluster.
type GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeCluster struct {
	Id string `json:"id"`
	// The public UUID for this cluster
	Uuid string `json:"uuid"`
	// Name of the cluster
	Name   string                                                                                                            `json:"name"`
	Queues GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnection `json:"queues"`
}

// GetId returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeCluster.Id, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeCluster) GetId() string {
	return v.Id
}

// GetUuid returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeCluster.Uuid, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeCluster) GetUuid() string {
	return v.Uuid
}

// GetName returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeCluster.Name, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeCluster) GetName() string {
	return v.Name
}

// GetQueues returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeCluster.Queues, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeCluster) GetQueues() GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnection {
	return v.Queues
}

// GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnection includes the requested fields of the GraphQL type ClusterQueueConnection.
type GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnection struct {
	Edges    []GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdge `json:"edges"`
	PageInfo GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionPageInfo                `json:"pageInfo"`
}

// GetEdges returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnection.Edges, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnection) GetEdges() []GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdge {
	return v.Edges
}

// GetPageInfo returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnection.PageInfo, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnection) GetPageInfo() GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionPageInfo {
	return v.PageInfo
}

// GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdge includes the requested fields of the GraphQL type ClusterQueueEdge.
type GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdge struct {
	Node GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdgeNodeClusterQueue `json:"node"`
}

// GetNode returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdge.Node, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdge) GetNode() GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdgeNodeClusterQueue {
	return v.Node
}

// GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdgeNodeClusterQueue includes the requested fields of the GraphQL type ClusterQueue.
type GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdgeNodeClusterQueue struct {
	Id          string `json:"id"`
	Key         string `json:"key"`
	Description string `json:"description"`
}

// GetId returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdgeNodeClusterQueue.Id, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdgeNodeClusterQueue) GetId() string {
	return v.Id
}

// GetKey returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdgeNodeClusterQueue.Key, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdgeNodeClusterQueue) GetKey() string {
	return v.Key
}

// GetDescription returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdgeNodeClusterQueue.Description, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionEdgesClusterQueueEdgeNodeClusterQueue) GetDescription() string {
	return v.Description
}

// GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionPageInfo includes the requested fields of the GraphQL type PageInfo.
// The GraphQL type's documentation follows.
//
// Information about pagination in a connection.
type GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionPageInfo struct {
	// When paginating forwards, are there more items?
	HasNextPage bool `json:"hasNextPage"`
	// When paginating forwards, the cursor to continue.
	EndCursor string `json:"endCursor"`
...
// GetHasNextPage returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionPageInfo.HasNextPage, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionPageInfo) GetHasNextPage() bool {
	return v.HasNextPage
}

// GetEndCursor returns GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionPageInfo.EndCursor, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionEdgesClusterEdgeNodeClusterQueuesClusterQueueConnectionPageInfo) GetEndCursor() string {
	return v.EndCursor
}

// GetOrganizationQueuesOrganizationClustersClusterConnectionPageInfo includes the requested fields of the GraphQL type PageInfo.
// The GraphQL type's documentation follows.
//
// Information about pagination in a connection.
type GetOrganizationQueuesOrganizationClustersClusterConnectionPageInfo struct {
	// When paginating forwards, are there more items?
	HasNextPage bool `json:"hasNextPage"`
	// When paginating forwards, the cursor to continue.
	EndCursor string `json:"endCursor"`
...
// GetHasNextPage returns GetOrganizationQueuesOrganizationClustersClusterConnectionPageInfo.HasNextPage, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionPageInfo) GetHasNextPage() bool {
	return v.HasNextPage
}

// GetEndCursor returns GetOrganizationQueuesOrganizationClustersClusterConnectionPageInfo.EndCursor, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesOrganizationClustersClusterConnectionPageInfo) GetEndCursor() string {
	return v.EndCursor
}

// GetOrganizationQueuesResponse is returned by GetOrganizationQueues on success.
type GetOrganizationQueuesResponse struct {
	// Find an organization
	Organization GetOrganizationQueuesOrganization `json:"organization"`
}

// GetOrganization returns GetOrganizationQueuesResponse.Organization, and is useful for accessing the field via an interface.
func (v *GetOrganizationQueuesResponse) GetOrganization() GetOrganizationQueuesOrganization {
	return v.Organization
}
...
// __ClusterQueueDeleteInput is used internally by genqlient
type __ClusterQueueDeleteInput struct {
	Input ClusterQueueDeleteInput `json:"input"`
}

// GetInput returns __ClusterQueueDeleteInput.Input, and is useful for accessing the field via an interface.
func (v *__ClusterQueueDeleteInput) GetInput() ClusterQueueDeleteInput { return v.Input }
...
// GetClusterUUID returns __GetClusterQueuesInput.ClusterUUID, and is useful for accessing the field via an interface.
func (v *__GetClusterQueuesInput) GetClusterUUID() string { return v.ClusterUUID }
...
// __GetOrganizationQueuesInput is used internally by genqlient
type __GetOrganizationQueuesInput struct {
	Slug          string `json:"slug"`
	ClustersFirst int    `json:"clustersFirst"`
	ClustersAfter string `json:"clustersAfter"`
	QueuesFirst   int    `json:"queuesFirst"`
}

// GetSlug returns __GetOrganizationQueuesInput.Slug, and is useful for accessing the field via an interface.
func (v *__GetOrganizationQueuesInput) GetSlug() string { return v.Slug }

// GetClustersFirst returns __GetOrganizationQueuesInput.ClustersFirst, and is useful for accessing the field via an interface.
func (v *__GetOrganizationQueuesInput) GetClustersFirst() int { return v.ClustersFirst }

// GetClustersAfter returns __GetOrganizationQueuesInput.ClustersAfter, and is useful for accessing the field via an interface.
func (v *__GetOrganizationQueuesInput) GetClustersAfter() string { return v.ClustersAfter }

// GetQueuesFirst returns __GetOrganizationQueuesInput.QueuesFirst, and is useful for accessing the field via an interface.
func (v *__GetOrganizationQueuesInput) GetQueuesFirst() int { return v.QueuesFirst }
...
// The mutation executed by ClusterQueueDelete.
const ClusterQueueDelete_Operation = `
...
func ClusterQueueDelete(
	ctx_ context.Context,
	client_ graphql.Client,
	input ClusterQueueDeleteInput,
) (data_ *ClusterQueueDeleteResponse, err_ error) {
	req_ := &graphql.Request{
		OpName: "ClusterQueueDelete",
		Query:  ClusterQueueDelete_Operation,
		Variables: &__ClusterQueueDeleteInput{
			Input: input,
		},
	}

	data_ = &ClusterQueueDeleteResponse{}
	resp_ := &graphql.Response{Data: data_}
...
// The query executed by GetOrganizationQueues.
const GetOrganizationQueues_Operation = `
...
func GetOrganizationQueues(
	ctx_ context.Context,
	client_ graphql.Client,
	slug string,
	clustersFirst int,
	clustersAfter string,
	queuesFirst int,
) (data_ *GetOrganizationQueuesResponse, err_ error) {
	req_ := &graphql.Request{
		OpName: "GetOrganizationQueues",
		Query:  GetOrganizationQueues_Operation,
		Variables: &__GetOrganizationQueuesInput{
			Slug:          slug,
			ClustersFirst: clustersFirst,
			ClustersAfter: clustersAfter,
			QueuesFirst:   queuesFirst,
		},
	}

	data_ = &GetOrganizationQueuesResponse{}
	resp_ := &graphql.Response{Data: data_}
